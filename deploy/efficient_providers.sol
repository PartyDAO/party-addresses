...
abstract contract Deploy {
    ...
    Globals public globals = Globals(payable(0x753e22d4e112a4D8b07dF9C4C578b116E3B48792));
...
contract DeployScript is Script, Deploy {
    ...
    function deploy(LibDeployConstants.DeployConstants memory deployConstants) public override {
        ...
        addressMapping[0] = AddressMapping("BasicMetadataProvider", address(basicMetadataProvider));
